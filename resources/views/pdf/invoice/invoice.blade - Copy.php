                ...
                <tr class="tr_body_tbody">
                    ...
                    <td style="border-bottom: 1px solid #e0e0e0;">
                        <table width="100%" border="0" cellspacing="0" cellpadding="0" style="text-align: left;">
                            ...
                            <tr>
                                <td style="padding:6pt 5pt;font-size:9pt; color: #666;   font-family: 'Open Sans', sans-serif;">
                                    <?php echo $data['job']->apartment_number." - ".$data['job']['apartment_type']->type." - ".$data['job']->apartment_status;?>
                                </td>
                            </tr>
                            </tbody>
                        </table>
                ...
                <tr class="tr_body_tbody">
                    <td style="border-bottom: 1px solid #e0e0e0;">
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            <tbody>
                                <tr>
                                    <td style="padding:6pt 5pt;font-size: 9pt; color: #666;  font-family: 'Open Sans', sans-serif;font-weight:700;">
                                        <?php echo date('m/d/Y',strtotime($service->end_date));?>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
            ...
            <tbody>
                <tr>
                    ...
                    <table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin-bottom: 20pt;margin-top: 20pt;">
                            <tbody>
                            <tr>
                                <td style="padding:0;color: #000;font-size: 10.046857pt;font-family: 'Open Sans', sans-serif;">* Non-taxable</td>
                            </tr>
                            <tr>
                            <td>
                                <p style="font-size:10pt;color: #000;  font-family: 'Open Sans', sans-serif;text-transform: uppercase;">Your Occupancy is Our Business</p>
                                <p style="font-size:10pt;color: #000;  font-family: 'Open Sans', sans-serif;">Thank You for Trusting Us to Serve You</p>
                            </td>
                        </tr>
