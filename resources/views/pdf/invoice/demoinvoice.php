...
<div class="page">
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                        <td style="font-size:14pt;font-weight: bold;padding: 0 0 6pt 0">
                            <img style="width: 300px" src=" <?php echo asset('images/logo.jpg') ?> " alt="">
                        </td>
                    </tr>
                    </tbody>
                </table>
        ...
        <tr>
            ...
            <td>
                <table width="100%" border="0" cellspacing="0" cellpadding="0" style='text-align: right;'>
                    <tbody>
                    <tr>
                        <td style="font-size:18.070286pt;padding:2pt 0;color: #000;font-weight:500;font-family: 'Montserrat', sans-serif;">Issued: <?php echo date("d/m/Y", strtotime($data->created_at));  ?></td>
                    </tr>
                    <tr>
                        <td style="font-size:18.070286pt;padding:2pt 0;color: #000;font-weight:500;font-family: 'Montserrat', sans-serif;">Due: <?php echo date("d/m/Y", strtotime($data->due_date));  ?></td>
                    </tr>
                    <tr>
        ...
        <tr>
            <td style="vertical-align: top;">
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                        <td style="font-size:12.046857pt;padding:2pt 0;color: #fff;font-weight:600;font-family: 'Montserrat', sans-serif;">
                        <?php $data['job']['property']['client']->contact_title ?> <?php $data['job']['property']['client']->contact_name ?>
                    </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td style="font-size:12.046857pt;padding:2pt 0;color: #fff;font-weight:400;font-family: 'Montserrat', sans-serif;">
                        <?php $data['job']['property']['client']->apartment_name ?><?php $data['job']['property']['client']->street_address ?>
                        </td>
                    </tr>
                    </tbody>
                </table>
            ...
            <td style="vertical-align: top;">
                <table width="100%" border="0" cellspacing="0" cellpadding="0" style='text-align: right;'>
                    ...
                    <tr>
                        <td style="font-size:12.046857pt;padding:2pt 0;color: #fff;font-weight:400;font-family: 'Montserrat', sans-serif;">
                        <?php echo $data['job']['property']->title ?>
                        </td>
                    </tr>
                    <tr>
                        <td style="font-size:12.046857pt;padding:2pt 0;color: #fff;font-weight:400;font-family: 'Montserrat', sans-serif;">
                        <?php echo $data['job']['property']->state. ",".$data['job']['property']->country.' '.$data['job']['property']->zipcode ?>
                        </td>
                    </tr>
                    </tbody>
                </table>
    ...
    <!--<table border="0" cellspacing="0" cellpadding="0" style="margin-bottom: 30pt;margin-top: 20pt;text-align: left;">
        ...
        <tr>
            ...
            <td style="padding:0;color: #00263e;font-size:13.552714pt;font-weight: 600;text-align: left;font-family: 'Montserrat', sans-serif;">Real Estate Service Systems LLC</td>
        </tr>
        </tbody>
    </table>-->
    <!-- =========== -->
        ...
        <tr>
            <td style="border-bottom: 1px solid #e0e0e0;">
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                        ...
                        <?php echo date("d/m/Y", strtotime($service->scheduled_date));  ?>
                        </td>
                    </tr>
                    </tbody>
                </table>
            ...
            <td style="border-bottom: 1px solid #e0e0e0;">
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                        <td style="padding:15pt 10pt;font-size: 10.541pt; color: #000000;font-weight:500;   font-family: 'Montserrat', sans-serif;">
                        <?php echo date("d/m/Y", strtotime($service->end_date));  ?>
                        </td>
                    </tr>
                    </tbody>
                </table>
