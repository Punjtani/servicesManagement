        ...
        <div v-if="!loading" class="dashboard_content_area">
            ...
            <div class="row">
                <div class="col-sm-6 col-8">
                  <h1 class="h4 heading_text">Calendar</h1>
                  <p class="job-calender"><span class="bottom_dots"> <span class="job__dot job_green__dot"></span>Completed</span><span class="bottom_dots"> <span class="job__dot job_red__dot"></span>Scheduled </span></p>
            ...
            <div class="card p-3">
                <div>
                    <div class="form-group jobs-calendar-date" >
              ...
              >
                <div class="wrap_popup_inner">
                  ...
                  <div class="details_box common_box">
                    <h6>Details</h6>
                    <p>
                     Job #: {{ arg.event.extendedProps.jobId }}
                    </p>
                      <p>
                ...
                <!-- <small class="text-primary mt-3"
                    >Note: Scheduled -> <span style="color:red;">Red</span> |
