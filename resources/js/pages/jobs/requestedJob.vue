        ...
        <div v-if="!loading" class="dashboard_content_area">
            <div class="row">
                <div class="col-sm-6 col-8">
                    <h1 class="h4 heading_text">Requests ({{ total ? total : "0" }})</h1>
                </div>
                    ...
                    <table class="table table-hover">
                        <thead>
                            <tr>
                                ...
                                <th>Service Type</th>
                                <th  v-if="role == roleData.admin || role == roleData.super_admin">Requested By</th>
                                <th>Requested For</th>
                                <!--<th>Status</th>-->
                                <th>Action</th>
                            </tr>
                        ...
                        <tbody v-if="jobs.length > 0">
                            <tr v-for="item in jobs" :key="item.id">
                                ...
                                <td data-title="Requested By" v-if="role == roleData.admin || role == roleData.super_admin">
                                    <span v-if="item.requested_by">{{ item.requested_by.first_name }}
                                        {{ item.requested_by.middle_name }} {{ item.requested_by.last_name }}</span><span
                                        v-else>--</span></td>
                                ...
                                <td data-title="Action">
                                    ...
                                    <div class="dropdown-menu custom-action-dropdown" aria-labelledby="dropdownMenuButton">
                                        <router-link
                                            ...
                                            <span v-if="role == roleData.client">Edit/Request</span>
                                            <span
                                                v-if="role == roleData.admin || role == roleData.super_admin">Edit/Assign</span>
                                        </router-link>
                                    </div>
                                </td>
                            </tr>
...
export default {
    ...
    methods: {
        ...
        getJobs() {
            ...
            axios.get('/api/job-request?page=' + this.table_jobs.current_page + '&sort_order=' + this.sortOrder + '&sort_by=' + this.sortBy + '&size=' + this.table_jobs.per_page +
