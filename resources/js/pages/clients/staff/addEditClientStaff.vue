            ...
            <div class="modal_content_inner">
                ...
                <div class="modal-bodys">
                    <div class="form_box">
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <div class="inline_checkbox checkbox_in_three">
                                    <div class="custom_checkbox w-100  client-email">
                                    <label>
                        ...
                        <h5 v-if="staffId && property_staff && !staff_form.view_all_properties" class="font_weight_600 font_family_Montserrat text_color_orange">Assign to a Property</h5>
                        <div class="row" v-if="staffId && property_staff && !staff_form.view_all_properties">
                            <div  class="col-sm-12">
                                <div class="form-group">
                                    <multiselect
