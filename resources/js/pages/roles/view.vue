    ...
    <div>
        ...
        <div v-if="!loading" class="dashboard_content_area">
            ...
            <div class="row align-items-center mb-4">
                <div class="col-sm-6 col-8"><h1 class="h4 mb-0">Roles</h1></div>
...
<!--                                <a v-if="!global_roles.includes(item.id)" data-bs-toggle="modal" data-bs-target="#deleteModel"-->
<!--                                    class="table_btn_link font_12 font_weight_700 text_uppercase" href="#"-->
<!--                                    @click="deleteRequest(item.id,'Role' , 'role')">Delete </a>-->

<!--                                    <span v-else-->
<!--                                    class="table_btn_link font_12 font_weight_700 text_uppercase disabled"-->
<!--                                    >&#45;&#45;&#45;&#45;&#45;&#45;&#45;&#45;&#45;&#45; </span>-->
<!--                                </span>-->
                                ...
                                <div class="dropdown-menu custom-action-dropdown" aria-labelledby="dropdownMenuButton">
                                    <a href="#" class="action_link table_btn_links font_12 font_weight_700 text_uppercase dropdown-item custom-action-bar"
                                       data-bs-toggle="modal" data-bs-target="#roleEdit"
                                       @click="editIdMethodRole(item.id)">Edit</a>
                                    <router-link class="action_link table_btn_links font_12 font_weight_700 text_uppercase dropdown-item custom-action-bar" v-bind:to="'/role-permissions/' + item.id">
                                        Permissions
                                    </router-link>
                                    <a v-if="!global_roles.includes(item.id)" data-bs-toggle="modal" data-bs-target="#deleteModel"
...
export default {
    ...
    methods: {
        ...
        getRoles() {
            ...
            axios.get('/api/roles?page='+this.table_roles.current_page+'&size='+this.table_roles.per_page + '&sort_order=' + this.sortOrder + '&sort_by=' + this.sortBy + '&search='+this.table_roles.search)
                .then((response) => {
