        ...
        <div v-if="!loading" class="dashboard_content_area">
            <div class="row">
                <div class="col-sm-6 col-8">
                    <h1 class="h4 heading_text">Past Due  ({{ total ? total : "0" }})</h1>
                </div>
                    ...
                    <div class="row align-items-center row_spacing_5">
                        ...
                        <div class="col-lg-4">
                            <div class="row text-sm-end row_spacing_5">
                                ...
                                <!--                            <div class="col-sm-3">-->
                                <!--                                <div class="form-group">-->
                                <!--                                    <multiselect  class=" text_capitalize" deselectLabel="" v-model.trim="table_invoices.status_filter"  placeholder="Status" :select-label="''" :options="table_invoices.status_filter_options" :searchable="true" :allow-empty="true"></multiselect>-->
                                <!--                                </div>-->
                                <!--                            </div>-->
                                <div class="col-sm-6">
                                    <div class="form-group">
                        ...
                        <thead>
                            <tr>
                                <th class="header-sort" :class="[sortBy == 'id' && sortOrder == 'desc'  ? 'desc' : '']" @click="sorting('id')">Invoice #</th>
                                    ...
                                    <!--                            <th>Bill</th>-->
                                    <th class="header-sort"  :class="[sortBy == 'is_paid' && sortOrder == 'desc'  ? 'desc' : '']" @click="sorting('is_paid')">Status</th>
                            ...
                            <tr v-for="item in invoices" :key="item.id">
                                ...
                                <td v-else data-title="Action">
                                    ...
                                    <div class="dropdown-menu custom-action-dropdown" aria-labelledby="dropdownMenuButton">
                                        ...
                                        <a @click="viewInvoice(item.id)" data-bs-toggle="modal"
                                            data-bs-target="#viewInvoice"
                                            class="action_link table_btn_links font_12 font_weight_700 text_uppercase dropdown-item custom-action-bar">View
                                            PDF</a>
                                    </div>
                                </td>
                            </tr>
    ...
    data() {
        return {
            ...
            table_invoices: {
                ...
                search: "",
                status_filter: "",
                status_filter_options: ["all", "paid", "not paid", "cancelled"],
                property_filter: "",
                apartment_filter: "",
                invoice_no_filter: "",
                date_filter: "",
